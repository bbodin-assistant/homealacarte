use homealacarte_web::{
    AppConfig, CustomGroceryItem, Engine, SourceFile, exclude_grocery_items, generate_grocery_pdf,
};
...
fn specialization_dataset(requirement_keys: &[&str], stock_key: &str) -> SourceFile {
    let ingredient = |key: &str, name: &str, generic_item_key: Option<&str>, purchase_item_key: Option<&str>| {
