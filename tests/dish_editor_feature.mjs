...
assert.match(index, /app\.js\?v=homealacarte-81/);
assert.match(entry, /app\/feature-composition\.js\?v=homealacarte-81/);
assert.match(entry, /worker\.js\?v=homealacarte-81/);
