...
assert.match(dialogs, /id="new-dish-name-en"/);
assert.match(dialogs, /id="new-dish-name-fr"/);
...
assert.match(index, /app\.js\?v=homealacarte-80/);
assert.match(entry, /app\/feature-composition\.js\?v=homealacarte-80/);
assert.match(entry, /worker\.js\?v=homealacarte-80/);
assert.match(app, /features\/dish-editor\.js\?v=homealacarte-80/);

console.log("Dish editor owns localized names, country metadata, compact controls, and cache-busted loading.");
