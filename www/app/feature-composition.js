...
import { createGroceryFeature } from "../features/grocery.js?v=homealacarte-82";
import { createDishesFeature } from "../features/dishes.js?v=homealacarte-104";
import { createAutoMenuFeature } from "../features/auto-menu.js?v=homealacarte-82";
import { createItemDetailsFeature } from "../features/item-details.js?v=homealacarte-104";
import { createDishEditorFeature } from "../features/dish-editor.js?v=homealacarte-80";
import { createCatalogueFeature } from "../features/catalogue.js?v=homealacarte-104";
import { createFamilyFeature } from "../features/family.js?v=homealacarte-104";
import { createMenuFeature } from "../features/menu.js?v=homealacarte-104";
