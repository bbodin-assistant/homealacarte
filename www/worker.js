import init, { HomeALaCarteEngine } from "./pkg/homealacarte_web.js?v=homealacarte-71";
...
async function ensureEngine() {
  if (!readyPromise) {
    const wasmUrl = new URL("./pkg/homealacarte_web_bg.wasm?v=homealacarte-71", self.location.href);
