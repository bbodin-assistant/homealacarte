import init, { HomeALaCarteEngine } from "./pkg/homealacarte_web.js?v=homealacarte-60";
...
async function ensureEngine() {
  if (!readyPromise) {
    const wasmUrl = new URL("./pkg/homealacarte_web_bg.wasm?v=homealacarte-60", self.location.href);
